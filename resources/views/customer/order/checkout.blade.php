        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <form action="{{ route('orders.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4" id="table_number_field" style="display: none;">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            ...
                            @if($qrisMethods->count() > 0)
                                <div class="mb-4">
                                    ...
                                    @foreach($qrisMethods as $method)
                                        <label class="flex items-start p-3 border-2 rounded-lg cursor-pointer hover:border-[#2e4358] transition-colors mb-2 {{ old('payment_method') == 'qris' ? 'border-[#2e4358] bg-blue-50' : 'border-gray-200' }}">
                                            <input type="radio" name="payment_method" value="qris" 
                                                   class="mt-1 mr-3 text-[#2e4358] focus:ring-[#2e4358]" required>
                                            <div class="flex-1">
                            ...
                            @if($bankTransferMethods->count() > 0)
                                <div class="mb-4">
                                    ...
                                    @foreach($bankTransferMethods as $method)
                                        <label class="flex items-start p-3 border-2 rounded-lg cursor-pointer hover:border-[#2e4358] transition-colors mb-2 {{ old('payment_method') == 'bank_transfer' ? 'border-[#2e4358] bg-blue-50' : 'border-gray-200' }}">
                            ...
                            <label class="flex items-start p-3 border-2 rounded-lg cursor-pointer hover:border-[#2e4358] transition-colors {{ old('payment_method') == 'cash' ? 'border-[#2e4358] bg-blue-50' : 'border-gray-200' }}">
                                <input type="radio" name="payment_method" value="cash" 
                                       class="mt-1 mr-3 text-[#2e4358] focus:ring-[#2e4358]" required>
                                <div class="font-medium text-gray-900">Tunai (Bayar di Tempat)</div>
                            </label>
                        </div>
                    ...
                    <div class="mb-6" id="proof_of_payment_field" style="display: none;">
                    ...
                    <button type="submit" class="w-full bg-[#2e4358] text-white py-3 rounded-lg hover:bg-[#1a2a3a] transition-colors font-semibold">
                        Buat Pesanan
                    </button>
                </form>
            </div>
